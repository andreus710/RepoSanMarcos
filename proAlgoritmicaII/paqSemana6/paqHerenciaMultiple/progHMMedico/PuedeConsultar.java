/*
 * Nombre PuedeConsultar.java
 *	Detalle: Esta clase es una Interface
 *			
 *		-	Los metodos no se implementan, tmpoco tienen llaves
 *		-	No estan obligados a utilizar el califcador:public, private, protected
